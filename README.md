...
- Cron trigger: every 5 minutes for position updates and exits. Signal scans run when stale, with a 10-minute default cadence, and are split into 4-symbol batches to reduce per-invocation Cloudflare Worker CPU spikes.
