...
- Cron trigger: every 5 minutes for position updates and exits. Signal scans run when stale, with a 10-minute default cadence to reduce Cloudflare Worker CPU spikes.
